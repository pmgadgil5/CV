...
app.post("/ajax/email", function (request, response) {
  ...
  const oauth2Client = new OAuth2(
    "244075068157-d4l2vps9tbk3s9db81kke1l4gbusjdt1.apps.googleusercontent.com", // ClientID
    "xw0T5z9twjK3VsquW31tUaTP", // Client Secret
    "https://developers.google.com/oauthplayground" // Redirect URL
  );

  oauth2Client.setCredentials({
    refresh_token:
      "1//040vlfymjlW_4CgYIARAAGAQSNwF-L9IrHl_bWWFm0OPiCVaklq9PjaZrmz3iJMKbXBKhP8zbGNzlKYqaZVk-oMCB5HzPyh6kxys",
  });
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      type: "OAuth2",
      user: "pmgadgil5@gmail.com",
      clientId:
        "244075068157-d4l2vps9tbk3s9db81kke1l4gbusjdt1.apps.googleusercontent.com",
      clientSecret: "xw0T5z9twjK3VsquW31tUaTP",
      refreshToken:
        "1//040vlfymjlW_4CgYIARAAGAQSNwF-L9IrHl_bWWFm0OPiCVaklq9PjaZrmz3iJMKbXBKhP8zbGNzlKYqaZVk-oMCB5HzPyh6kxys",
  ...
  var mail = {
    from: "pmgadgil5@gmail.com", // sender address
    to: "pmgadgil5@gmail.com", // list of receivers (THIS COULD BE A DIFFERENT ADDRESS or ADDRESSES SEPARATED BY COMMAS)
